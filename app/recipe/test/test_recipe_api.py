...
def image_upload_url(recipe_id):
    """Create and return an image return url"""
...
class PublicRecipeAPITests(TestCase):
    """Test unauthenticades API request."""
...
class PrivaterecipeAPITest(TestCase):
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        for tag in payload['tags']:
            axists = recipe.tags.filter(
                name = tag['name'],
                user = self.user,
            ).exists()
            self.assertTrue(axists)
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('5.50'),
            'ingredients': [{'name': 'Curry'}, {'name': 'prawn'}],
            'tags': [{'name': 'Indian'}, {'name': 'Breakfast'}],
            'description': 'sample description',
            'link': 'http://example.com/recipe.pdf'
        }
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        ingredient_salt = Ingredients.objects.create(name = 'salt', user = self.user)
        payload = {
            'title':'Thai prawn Curry',
            'time_minutes': 30,
            'price': Decimal('5.50'),
            'ingredients': [{'name': 'Curry'}, {'name': 'salt'}],
            'tags': [{'name': 'Indian'}, {'name': 'Breakfast'}],
            'description': 'sample description',
            'link': 'http://example.com/recipe.pdf'
        }
        ...
        for ingredient in payload['ingredients']:
            axists = recipe.ingredients.filter(
                name = ingredient['name'],
                user = self.user,
            ).exists()
            self.assertTrue(axists)
